...
export const metadata: Metadata = {
  title: "Home",
  description: "Kiet Nguyen is a software engineer specializing in scalable systems and microservices. Explore insights about modern web development, technology, and engineering best practices.",
  openGraph: {
    title: "Kiet Nguyen - Software Engineer",
    description: "Software engineer specializing in scalable systems and microservices. Explore insights about modern web development and technology.",
        ...
        <section className="mb-32">
          ...
          <section className="mb-32">
            <div className="text-left">
              <h2 className="text-lg font-medium mb-8 uppercase tracking-wider">Latest Posts</h2>
                ...
                <article className="border-b border-gray-100 pb-6 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-shrink-0 mt-1">
                      <svg className="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 640 512">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 leading-relaxed">
                        exploring best practices for designing microservices architecture using kotlin and spring boot...
                      </p>
                    </div>
                  </div>
                </article>
                ...
                <article className="border-b border-gray-100 pb-6 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 leading-relaxed">
                        techniques for improving react application performance through memoization and code splitting...
                      </p>
                    </div>
                  </div>
                </article>
                ...
                <article className="border-b border-gray-100 pb-6 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 leading-relaxed">
                        practical approaches to reducing aws infrastructure costs without compromising performance...
                      </p>
                    </div>
                  </div>
                </article>
